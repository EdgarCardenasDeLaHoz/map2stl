...
| F-SKY-PIPELINE | Consolidate F-SKY1..F-SKY11.1 into one canonical pipeline with each signal classified as core / opt-in / diagnostic-only — see [plans/F-SKY-PIPELINE-CONSOLIDATION.md](plans/F-SKY-PIPELINE-CONSOLIDATION.md). Reference document; the refactor lands in phases as F-SKY11.1 Phase B + F-SKY3/10 cleanup + Miami scaffolding. | `city2stl/skyline_cv/region_pdf.py`, `city2stl/skyline_cv/README.md` | Medium | pending |
