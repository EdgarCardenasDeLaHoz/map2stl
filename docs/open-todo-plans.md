...
For new work, write the plan in [`docs/proposals.md`](proposals.md) and link from there.
...
| Topic | File |
|---|---|
| Building-height ML model | [`docs/plans/height-training-status.md`](plans/height-training-status.md) |
| Height pipeline improvements still open | [`docs/height-pipeline-improvement-plan.md`](height-pipeline-improvement-plan.md) |
| New AI-generated proposals | [`docs/proposals.md`](proposals.md) |
| Active issues / tech debt | [`docs/issues.md`](issues.md) |
