...
Definition lives in `tools/example/networks.py`.
...
OSM tag coverage drops sharply outside Europe — `--label-source providers` is the workaround. See [`../plans/height-data-sources.md`](../plans/height-data-sources.md) for the merge strategy.
