"""Unit tests for city2stl.skyline.osm_water (F-SKY13 Phase A).
...
from city2stl.skyline.osm_water import (
    _haversine_m,
    clip_to_radius,
...
class TestOSMKeypointsForScoring:
    ...
    def test_shape_matches_satellite_keypoints(self):
        ...
        from city2stl.skyline.osm_water import osm_keypoints_for_scoring
