...
from city2stl.skyline_cv.height.providers.copernicus import (
    CopernicusProvider,
    _is_in_europe,
...
class TestCopernicusFetch:
    @patch("city2stl.skyline_cv.height.providers.copernicus.read_array_cache", return_value=None)
    @patch("city2stl.skyline_cv.height.providers.copernicus.write_array_cache")
    @patch("city2stl.skyline_cv.height.providers.copernicus._fetch_eu_wcs")
    ...
    @patch("city2stl.skyline_cv.height.providers.copernicus.read_array_cache")
