...
class TestSessionPlumbing:
    ...
    def test_unknown_provider_skipped(self, monkeypatch, tmp_path, capsys):
        ...
        with patch(
            "city2stl.skyline_cv.height.providers.wsf3d.WSF3DProvider.fetch_heights",
    ...
    def test_no_results_sets_none(self, monkeypatch, tmp_path, capsys):
        ...
        with patch(
            "city2stl.skyline_cv.height.providers.google_3d._get_api_key",
            return_value=None,
        ):
...
class TestSingleProvider:
    ...
    def test_google3d_only(self, monkeypatch, tmp_path):
        ...
        with patch(
            "city2stl.skyline_cv.height.providers.google_3d.Google3DProvider.covers",
            return_value=True,
        ), patch(
            "city2stl.skyline_cv.height.providers.google_3d.Google3DProvider.fetch_heights",
            return_value=fake,
        ):
            s.fetch_building_heights(providers=["google3d"])
        assert s.building_heights is not None
    ...
    def test_copernicus_only(self, monkeypatch, tmp_path):
        ...
        with patch(
            "city2stl.skyline_cv.height.providers.copernicus.CopernicusProvider.fetch_heights",
            return_value=fake,
        ):
    ...
    def test_ndsm_only(self, monkeypatch, tmp_path):
        ...
        with patch(
            "city2stl.skyline_cv.height.providers.ndsm.NDSMProvider.fetch_heights",
            return_value=fake,
        ):
    ...
    def test_lidar_3dep_only(self, monkeypatch, tmp_path):
        ...
        with patch(
            "city2stl.skyline_cv.height.providers.lidar_3dep.LiDAR3DEPProvider.fetch_heights",
            return_value=fake,
        ):
...
class TestMultiProviderMerge:
    ...
    def test_all_five_providers(self, monkeypatch, tmp_path):
        ...
        with patch(
            ...
            "city2stl.skyline_cv.height.providers.copernicus.CopernicusProvider.covers",
