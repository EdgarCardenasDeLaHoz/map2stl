...
from app.server.core.height.providers.lidar_3dep import (
    LiDAR3DEPProvider,
    _is_in_us,
    _CONFIDENCE,
)
...
class TestLiDARFetch:
    @patch("app.server.core.height.providers.lidar_3dep.read_array_cache", return_value=None)
    @patch("app.server.core.height.providers.lidar_3dep.write_array_cache")
    @patch("app.server.core.height.providers.lidar_3dep._fetch_3dep_image")
    ...
    @patch("app.server.core.height.providers.lidar_3dep.read_array_cache")
